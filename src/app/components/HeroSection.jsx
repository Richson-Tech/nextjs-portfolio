  ...
  return (
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-3xl sm:text-5xl xl:text-6xl 2xl:text-8xl lg:leading-normal font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-600">
              Hello, I&apos;m{" "}
            </span>
            <br></br>
            <TypeAnimation
              sequence={["Folorunsho Ahmed", 1000, "Fullstack Dev.", 1000]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
            />
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-lg lg:space-x-3">
            As an experienced fullstack developer, I excel in the creation and
        ...
        >
          <div className=" relative mt-10 w-[250px] h-[250px] xl:w-[300px] xl:h-[300px] 2xl:w-[400px] 2xl:h-[400px]">
            <Image
              src="/images/me.jpg"
              alt="Ahmed"
